    ...
    switch ([self lastButtonTag]) {
        ...
        case AppEventRated:
        {
            content = @[@{FBSDKAppEventParameterNameContentID: @"10001",
                          ...
                          FBSDKAppEventParameterNameDescription: @"xford Shirts",
                          FBSDKAppEventParameterNameCurrency: @"USD",
                          @"PromotionCode": @"12345",
                          @"Value":@49.99},
                        @{FBSDKAppEventParameterNameContentID: @"20001",
                          FBSDKAppEventParameterNameContentType: @"Shorts",
                          FBSDKAppEventParameterNameDescription: @"Oxford Shorts",
                          FBSDKAppEventParameterNameCurrency: @"USD",
                          @"PromotionCode": @"10000",
                          @"Value":@59.99}];
        }
        ...
        case AppEventAddedToCart:
        {
            content = @[@{FBSDKAppEventParameterNameContentID: @"10001",
                          FBSDKAppEventParameterNameContentType: @"Shirts",
                          FBSDKAppEventParameterNameDescription: @"Oxford Shirts",
